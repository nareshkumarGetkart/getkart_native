                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 10) {
                        ...
                        VStack {
                            ...
                            if transaction?.walletTransaction?.type.lowercased() == "credit"{
                                Text("Successfully Added  \(Local.shared.currencySymbol) \(transaction?.walletTransaction?.amount ?? 0)")
                        ...
                        HStack{
                         ...
                         }else if let _ = transaction?.walletTransaction?.id{
                            //Wallet added
                            walletDetailsCard()
                        ...
                        if let _ = transaction?.walletTransaction?.txnID{
                        ...
                        if  let _  = transaction?.invoiceId{
                            Button(action: {
                                getPdfUrlFromView()
...
private func detailsCard() -> some View {
    ...
    @ViewBuilder
    private func walletDetailsCard() -> some View{
