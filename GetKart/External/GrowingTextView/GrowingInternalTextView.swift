...
internal class GrowingInternalTextView: UITextView, NSCopying {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let placeholderSize:CGSize = sizeForAttributedString(placeholder)
      ...
      //  let rect = CGRect(origin: CGPoint(x: xPosition, y: yPosition), size: CGSizeMake(placeholderSize.width, placeholderSize.height+10))
